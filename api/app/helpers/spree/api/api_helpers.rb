  ...
  module Api
    module ApiHelpers
      ...
      def variant_attributes
        [:id, :name, :sku, :price, :weight, :height, :width, :depth, :is_master, :cost_price, :slug, :fulfillment_cost, :small_image_url, :large_image_url, :max_image_url]
      end
      ...
      def order_attributes
        [:id, :number, :item_total, :total, :ship_total, :state, :adjustment_total, :user_id, :created_at, :updated_at, :completed_at, :payment_total, :shipment_state, :payment_state, :email, :special_instructions, :token, :channel, :currency, :cancel_reason, :synced_at]
      end
